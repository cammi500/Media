          ...
          <div class="active tab-pane" id="activity">
            ...
            <form class="form-horizontal" method="post"  action="{{route('admin#update')}}">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="email" name="adminEmail" class="form-control" id="inputEmail" placeholder="Email" value="{{old('adminEmail',$user->email)}}">
                  @error('adminEmail')
                  <div class="text-danger">{{$message}}</div>
                @enderror
                </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="phone" name="adminPhone" class="form-control" id="inputPhone" placeholder="Phone" value="{{$user->phone}}">
                </div>
              </div>
              <div class="form-group row">
                <label for="inputEmail"  class="col-sm-2 col-form-label">Address</label>
                <div class="col-sm-10">
                  <textarea class="form-control" name="adminAddress" placeholder="Address.." value="{{$user->address}}"></textarea>
                </div>
              </div>
              <div class="form-group row">
                ...
                <select class="form-control" name="adminGender">
                 ...
                 @elseif ($user->gender == 'female')
                   ...
                   @else
                    <option  value="empty" selected>Choose the options</option>
                    <option value="male">Male</option>
                    <option value="female">Female</option>
                   @endif
                  </select>
